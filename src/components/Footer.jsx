      ...
      <div className="mx-auto w-full max-w-7xl px-8">
        <div className="mt-12 flex w-full flex-col items-center justify-center py-10 md:flex-row md:justify-between">
          ...
          <div className="flex gap-12 text-myColor-2 sm:justify-center">
            ...
            <Typography as="a" href="https://discord.com/channels/@redprice247" target="_blank" className="opacity-80 transition-opacity hover:opacity-100">
              <svg className="h-10 w-10" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                <path
                  fill-rule="evenodd"
            ...
            <Typography as="a" href="https://github.com/newprice247" target="_blank" className="opacity-80 transition-opacity hover:opacity-100">
              <svg className="h-10 w-10" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                <path
                  fill-rule="evenodd"
