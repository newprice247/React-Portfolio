    ...
    <>
      ...
      <motion.div
        ...
        >
          <img
            alt="Nathan Price"
            className="object-contain items-center h-96 w-96 rounded-full"
            src={nathanPic}
          />
        </div>
        <div
